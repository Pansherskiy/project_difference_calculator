...
def test_generate_diff_for_empty_files(json_file1,
                                       json_file2,
                                       yaml_file1,
                                       yaml_file2,
                                       empty_file):
...
def test_generate_diff_for_simple_json_files(json_file1,
                                             json_file2,
                                             simple_json_result1,
                                             simple_json_result2,
                                             simple_json_result3,
...
def test_generate_diff_for_nested_json_files(nested_json_file1,
                                             nested_json_file2,
                                             nested_json_result1,
                                             nested_json_result2,
                                             nested_json_result3,
...
def test_generate_diff_for_simple_yaml_files(yaml_file1,
                                             yaml_file2,
                                             simple_yaml_result1,
                                             simple_yaml_result2):
...
def test_generate_diff_for_nested_yaml_files(nested_yaml_file1,
                                             nested_yaml_file2,
                                             nested_yaml_result1,
                                             nested_yaml_result2):
